...
import { EditUserArea } from '@/services/nebula/user';
          ...
          <Space style={{ cursor: 'pointer' }} align="start" size={'large'}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item href="#">Edit User Area</Breadcrumb.Item>
              </Breadcrumb>
        ...
        >
          <Row gutter={16}>
            ...
            <Col span={12}>
              ...
              >
                <AreaDropdown value={state.dataEdit.area_id} onChange={() => {}} />
              </Form.Item>
            </Col>
            <Col span={12}>
