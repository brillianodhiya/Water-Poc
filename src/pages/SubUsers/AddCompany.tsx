import { AddUserCompany } from '@/services/nebula/user';
...
const AddCompany: React.FC<Props> = ({}) => {
  ...
  const onFinish = async (values: any) => {
    console.log(values);
    setLoading(true);
    const data = await AddUserCompany({
      name: values.name,
      phone: values.phone,
      email: values.email,
          ...
          <Space style={{ cursor: 'pointer' }} align="start" size={'large'}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item href="#">Add User Company</Breadcrumb.Item>
              </Breadcrumb>
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item
                ...
                requiredMark="optional"
              >
                <Select placeholder="Select Role" className="not-rounded">
                  <Select.Option value="1">Admin</Select.Option>
                  <Select.Option value="4">Finance</Select.Option>
                  <Select.Option value="5">Technician</Select.Option>
                </Select>
              </Form.Item>
            </Col>
            {/* <Col span={12}>
