...
import {
  ...
  PressureIcon,
  PressurePTIcon,
} from '@/components/Icons/Pressure';
import { RTUIcon } from '@/components/Icons/RTU';
import { getUserAreaById } from '@/services/nebula/user';
import {
  ArrowLeftOutlined,
  EditOutlined,
  KeyOutlined,
...
const DetailArea: React.FC = () => {
  ...
  const getData = async () => {
    setLoading(true);
    const data = await getUserAreaById(state?.user_id);
      ...
      >
        <Col xxl={8} xl={8} lg={8} md={24} sm={24} xs={24}>
          <Row gutter={[16, 16]}>
            ...
            <Col xs={16} sm={16} md={20} lg={16} xl={16} xxl={20}>
              <Typography.Link
                onClick={() =>
                  history.push('/users/area/password', {
                    user_id: dataUser.id,
                    type: 'area',
                  })
                }
        ...
        <Col xxl={16} xl={16} lg={16} md={24} sm={24} xs={24}>
          ...
          >
            ...
            <Table dataSource={dataSource} pagination={{ position: [] }} loading={loading}>
              <Column
                title="Ticket Name"
              ...
              },
              {
                title: (
                  <Space wrap>
                    ...
                    <Typography.Link>Sonja Crooks MD</Typography.Link>
                    <Typography.Text type="secondary">
                      No Ticket : 2022-05-__DEV__-913
                    </Typography.Text>
                  </Space>
