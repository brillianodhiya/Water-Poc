...
import { getPressureVacuum } from '@/services/badiklat/dashboard';
...
export const WaterPressureVacuum: FunctionComponent<ViewLogTypes> = ({
  loading,
  dataWaterPressure = [
    // {
  ...
  React.useEffect(() => {
    if (modalDetail) {
      ...
      const getData = async () => {
        const w = await getPressureVacuum({});
