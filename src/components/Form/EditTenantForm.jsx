...
const EditTenantForm = ({ title, open, onOk, onCancel, dataEdit }) => {
  ...
  return (
    <Modal
      ...
      okText="Save"
    >
      <Form form={form} name="add-tenant" onFinish={onFinish} layout="vertical">
        <Form.Item noStyle>
